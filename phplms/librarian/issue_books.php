                    ...
                    <div class="x_content">
                        <form name="form1" action="" method="post">
                            ...
                            if(isset($_POST["submit1"]))
                            {
                                ...
                                <tr>
                                    <td><input type="text" class="form-control" placeholder="Enrollment No" name="enrollmentno" value = "<?php echo $enrollmentno; ?>"disabled></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><input type="text" class="form-control" placeholder="Books Issue Date" name="booksissuedate" value = "<?php echo date("Y-m-d"); ?>"required></td>
                                </tr>
                                <tr>
                                    <td><input type="text" class="form-control" placeholder="Student User Name" name="studentusername" value = "<?php echo $username; ?>"disabled></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" value = "Issue Book"  name="submit2" class = "form-control btn btn-default"  style = "background-color: lightblue; color: black"></td>
                                </tr>
                        ...
                        if(isset($_POST["submit2"]))
                        {
                            ...
                            if($qty==0)
                            {
                                ...
                                <div class="alert alert-danger col-lg-6 col-lg-push-3">
                                    <strong style="color:white">The book is not available in the stock</strong> 
                                </div>
                            ...
                            mysqli_query($link, "insert into issue_books value('','$_SESSION[enrollmentno]','$_POST[studentname]','$_POST[studentsem]','$_POST[studentcontact]','$_POST[studentemail]','$_POST[booksname]','$_POST[booksissuedate]','','$_SESSION[susername]') ");
